    ...
    default:       /* el resto de instrucciones */
      ...
      switch (solucion_riesgos_datos) {
        ...
        case cortocircuito:
          ...
          /** Insertar código */
          /*  WBaEXalu_s */
          if (usaIR_destino_WB() && usaIR_fuente1_EX() && MEM_WB.IR.Rdestino == ID_EX.IR.Rfuente1)
              result = wb;
          /*  MEMaEXalu_s */
          if (usaIR_destino_MEM() && usaIR_fuente1_EX() && EX_MEM.IR.Rdestino == ID_EX.IR.Rfuente1)
              result = mem;
          break;
      }
  }
    ...
    default: /* el resto de instrucciones */
      ...
      switch (solucion_riesgos_datos) {
        ...
        case cortocircuito:
          ...
          /** Insertar código */
          /*  WBaEXalu_i */
          if (usaIR_destino_WB() && usaIR_fuente2_EX() && MEM_WB.IR.Rdestino == ID_EX.IR.Rfuente2)
              result = wb;
          /*  MEMaEXalu_i */
          if (usaIR_destino_MEM() && usaIR_fuente2_EX() && EX_MEM.IR.Rdestino == ID_EX.IR.Rfuente2)
              result = mem;
          break;
      }
  }
...

{
  ...
  switch (solucion_riesgos_datos) {
    ...
    if ((usaIR_destino_EX() &&
            ((usaIR_fuente1_ID() && IF_ID.IR.Rfuente1 == ID_EX.IR.Rdestino) ||
             (usaIR_fuente2_ID() && IF_ID.IR.Rfuente2 == ID_EX.IR.Rdestino))) ||
            (usaIR_destino_MEM() &&
            ((usaIR_fuente1_ID() && IF_ID.IR.Rfuente1 == EX_MEM.IR.Rdestino) ||
             (usaIR_fuente2_ID() && IF_ID.IR.Rfuente2 == EX_MEM.IR.Rdestino)))) {
        IDstall = SI;
        IFstall = SI;
    }
